...
export const IssueForm = ({ issue, onSave, onCancel }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (issue) {
                savedIssue = await issueService.updateIssue(issue.id, formData);
            } else {
                savedIssue = await issueService.createIssue(formData);
            }
